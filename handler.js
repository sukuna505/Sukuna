  ...
  for (const nk of callUpdate) {
    if (nk.isGroup == false) {
      if (nk.status == 'offer') {
        ...
        const vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;SUKUNA;;;\nFN:BOT\nORG:KIM\nTITLE:\nitem1.TEL;waid=212703979081:212703979081\nitem1.X-ABLabel:kim\nX-WA-BIZ-DESCRIPTION:[❗] contact Du ji\nEND:VCARD`;
        await mconn.conn.sendMessage(nk.from, {contacts: {displayName: 'SUKUNA', contacts: [{vcard}]}}, {quoted: callmsg});
...
global.dfail = (type, m, conn) => {
  ...
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: '*[ ⚠ ] Warning*', body: 'Sukuna Bot', thumbnail: imagen1, sourceUrl: 'https://instagram.com/lyr.du.ji
	  '}}}}, aa);
